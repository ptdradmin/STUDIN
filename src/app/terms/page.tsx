        ...
        <div className="container mx-auto px-4 py-8 md:py-16">
             <Card className="py-10 px-6 max-w-4xl mx-auto shadow-lg">
                <CardContent className="prose max-w-none">
                    ...
                    <p>STUD'IN est une plateforme de mise en relation. Nous ne sommes pas partie prenante aux accords conclus entre les utilisateurs (par exemple, un contrat de location, un accord de covoiturage, une séance de tutorat, une vente de livre ou la réalisation d'un défi).</p>
                    <ul>
                       <li>Nous ne garantissons pas la qualité, la sécurité, ou la légalité des annonces, des services et des défis proposés par les utilisateurs.</li>
