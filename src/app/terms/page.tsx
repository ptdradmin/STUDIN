                 ...
                 <Card className="py-10 px-6">
                    <CardContent className="prose max-w-none">
                        ...
                        <div className="text-center py-10 mt-6 bg-muted rounded-lg">
                            ...
                            <p className="text-muted-foreground mt-2">Pour toute question concernant ces conditions, veuillez nous contacter à <a href="mailto:legal@studin.app" className="text-primary hover:underline">legal@studin.app</a>.</p>
                        </div>
                    </CardContent>
                </Card>
            </div>
