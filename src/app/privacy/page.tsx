            ...
            <div className="container mx-auto px-4 py-8">
                <Card className="py-10 px-6">
                    <CardContent className="prose max-w-none">
                        ...
                        <p>Pour toute question relative à cette politique ou pour exercer vos droits, veuillez nous contacter à l'adresse <a href="mailto:privacy@studin.app">privacy@studin.app</a>.</p>
