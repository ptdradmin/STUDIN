                 ...
                 <Link href="/community-rules">
                     <Card className="h-full hover:shadow-lg transition-shadow lg:col-span-1 md:col-span-2">
                           <CardHeader>
                                ...
                                <CardTitle className="text-center">Règles de la communauté</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <CardDescription className="text-center">Consultez les règles pour un environnement sûr et respectueux.</CardDescription>
                            </CardContent>
                        </Card>
                 </Link>
             </div>
